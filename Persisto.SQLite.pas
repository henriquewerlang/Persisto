...
function TDatabaseManipulatorSQLite.ExtractFixedValue(const Expression: String): String;
begin
  Result := EmptyStr;
end;

function TDatabaseManipulatorSQLite.GetAutoGeneratedDefinition(const AutoGenerated: TAutoGeneratedType): String;
const
