...
begin
  ...
  begin
    var CurrentCachedObject := CachedObject.&Object;
    ...
    for var Field in Table.Fields do
      ...
      begin
        ...
        if FieldValueString <> Field.GetAsString(CurrentCachedObject) then
        begin
        ...
        if not Field.ReadOnly then
          Field.SetValue(CurrentCachedObject, Field.GetValue(CurrentObject));
      end;
