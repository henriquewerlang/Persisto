...
begin
  ...
  else if Field.AutoGenerated then
    TValue.Make(nil, Field.FieldType.Handle, Field.FDefaultValue)
  else
    ...
    case SpecialType of
      ...
      stTime: Result := QuotedStr(TimeToStr(Value.AsExtended, TValue.FormatSettings))
        ...
        case Value.Kind of
          ...
          tkClass: Result := ForeignKey.ParentTable.PrimaryKey.GetAsString(Value.AsObject);

          tkFloat: Result := FloatToStr(Value.AsExtended, TValue.FormatSettings);

          tkEnumeration,
          tkInteger,
          tkInt64: Result := Value.GetAsString;
