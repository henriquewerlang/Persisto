unit Persisto.Lazy.Manipulator;

interface

uses System.Rtti, Persisto.Lazy;
...
uses System.SysUtils, System.TypInfo, Persisto.Rtti.Helper{$IFDEF PAS2JS}, JS{$ENDIF};
...
begin
  Result := GetManipulator(@LazyInstance, Persisto.Rtti.Helper.GetRttiType(TypeInfo(T)));
end;
