...
function TDatabaseManipulatorPostgreSQL.ExtractFixedValue(const Expression: String): String;
begin
  Result := Expression.Split(['::'])[0];
end;

function TDatabaseManipulatorPostgreSQL.GetAutoGeneratedDefinition(const AutoGenerated: TAutoGeneratedType): String;
const
