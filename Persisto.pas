...
type
  ...
  public
    constructor Create(const MetadaManipulator: IMetadataManipulator);
  ...
  private
    ...
    FMapper: TMapper;
    FMetadaManipulator: IMetadataManipulator;
  ...
  public
    constructor Create(const Connection: IDatabaseConnection; const MetadaManipulator: IMetadataManipulator);
...
procedure TDatabaseMetadataUpdate.CheckChangingTheList<T>(const List: Lazy<TArray<T>>; const Func: TFunc<T, Boolean>);
begin
  var A := 0;
...
begin
  ...
  FManager := Manager;
  FMetadataManipulator := Manager.FMetadaManipulator;
...
function TMetadataManipulator.MakeInsertStatement(const Table: TTable; const Params: TParams): String;
begin
...
function TMetadataManipulator.MakeUpdateStatement(const Table: TTable; const Params: TParams): String;
begin
  Result := EmptyStr;
...
begin
  Result := FManager.OpenCursor(SQL);
end;
...
constructor TManager.Create(const Connection: IDatabaseConnection; const MetadaManipulator: IMetadataManipulator);
begin
  inherited Create;
...
constructor TDatabaseClassGenerator.Create(const MetadaManipulator: IMetadataManipulator);
begin
