...
type
  ...
  IDatabaseManipulator = interface
    ...
    function CreateTable(const Table: TTable): String;
...
function TDatabaseManipulator.CreateTable(const Table: TTable): String;
begin
//  var Fields := EmptyStr;
//
//  for var Field in Table.Fields do
...
function TDatabaseManipulator.GetDefaultConstraintName(const Field: TField): String;
begin
