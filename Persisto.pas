...
var
  ...
  begin
    ...
    try
      ...
      for var Field in Table.Fields do
        ...
        begin
          if Field.HasValue(&Object, FieldValue) and Field.IsForeignKey then
            InsertTable(Field.ForeignKey.ParentTable, FieldValue.AsObject);
      ...
      begin
        FieldValue := TValue.From(Cursor.GetFieldValue(FieldIndex));
...
var
  ...
  begin
    ...
    try
      ...
      begin
        if Field.HasValue(&Object, FieldValue) and Field.IsForeignKey then
          UpdateTable(Field.ForeignKey.ParentTable, FieldValue.AsObject);
