unit Persisto.Lazy.Factory;

interface

uses System.Rtti, Persisto.Lazy, Persisto.Mapper, Persisto.Cache, Persisto.Connection, Persisto.Query.Builder;
...
uses System.TypInfo, Persisto.Rtti.Helper;
