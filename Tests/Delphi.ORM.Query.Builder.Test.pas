...
procedure TQueryBuilderDataManipulationTest.WhenUpdatingAClassWithDefaultValueAndTheValueIsntChangedCantUpdateTheField;
begin
  var MyClass := TMyEntityWithDefaultValue.Create;
  MyClass.AEnum := Enum3;
  MyClass.AField := 'MyField';
  MyClass.Id := 123;

  AddObjectToCache(TMyEntityWithDefaultValue.Create, 123);

  Builder.Update(MyClass);

  Assert.AreEqual('update MyEntityWithDefaultValue set AField=''MyField'' where Id=123', DatabaseClass.SQL);
end;
