...
type
  ...
  public
    ...
    [Test]
    procedure WhenConvertAnIntegerValueMustConvertTheStringAsExpected;
    [Test]
    procedure WhenConvertAnInteger64ValueMustConvertTheStringAsExpected;
    [Test]
    procedure WhenConvertAStringValueMustConvertTheStringAsExpected;
    [Test]
    procedure WhenConvertAFloatNumberValueMustConvertTheStringAsExpected;
    [Test]
    procedure WhenConvertAnAnsiStringValueMustConvertTheStringAsExpected;
    [Test]
    procedure WhenConvertAnEnumerationValueMustConvertTheStringAsExpected;
    [Test]
    procedure WhenConvertAGUIDRecordValueMustConvertTheStringAsExpected;
    [Test]
    procedure WhenConvertAInvalidTypeValueMustRaiseAnError;
    [Test]
  ...
  public
    ...
    [TestCase('Equal.Condition', 'qboEqual')]
    [TestCase('Not Equal.Condition', 'qboNotEqual')]
    procedure WhenCompareTheFieldWithAnObjectMustCompareThePrimaryKeyAsExpected(Operation: TQueryBuilderOperator);
  end;
...
uses System.SysUtils, System.Variants, Delphi.ORM.Mapper, Delphi.ORM.Cursor.Mock;
...
procedure TDelphiORMQueryBuilderTest.WhenConvertAGUIDRecordValueMustConvertTheStringAsExpected;
begin
  var GUID := TGUID.Create(123, 123, 123, 123, 123, 123, 123, 123, 123, 123, 123);

  Assert.AreEqual(QuotedStr(GUID.ToString), GetValueString(TValue.From(GUID)));
end;

procedure TDelphiORMQueryBuilderTest.WhenConvertAInvalidTypeValueMustRaiseAnError;
begin
  Assert.WillRaise(
    procedure
    begin
...
procedure TDelphiORMQueryBuilderTest.WhenConvertAnAnsiStringValueMustConvertTheStringAsExpected;
begin
  Assert.AreEqual('''abc''', GetValueString(AnsiString('abc')));
end;

procedure TDelphiORMQueryBuilderTest.WhenConvertAnEnumerationValueMustConvertTheStringAsExpected;
begin
  Assert.AreEqual('1', GetValueString(TValue.From(Enum2)));
end;

procedure TDelphiORMQueryBuilderTest.WhenConvertAnInteger64ValueMustConvertTheStringAsExpected;
begin
  Assert.AreEqual('1234', GetValueString(Int64(1234)));
end;

procedure TDelphiORMQueryBuilderTest.WhenConvertAnIntegerValueMustConvertTheStringAsExpected;
begin
  Assert.AreEqual('1234', GetValueString(1234));
end;

procedure TDelphiORMQueryBuilderTest.WhenConvertAStringValueMustConvertTheStringAsExpected;
begin
  Assert.AreEqual('''abc''', GetValueString('abc'));
end;
...
procedure TDelphiORMQueryBuilderConditionTest.Setup;
begin
  TMapper.Default.LoadAll;
end;
...
procedure TDelphiORMQueryBuilderConditionTest.WhenCompareTheFieldWithAnObjectMustCompareThePrimaryKeyAsExpected(Operation: TQueryBuilderOperator);
begin
  ...
  case Operation of
    qboEqual: Condition := Field('MyField') = MyClass;
    qboNotEqual: Condition := Field('MyField') <> MyClass;
  end;

  Assert.AreEqual(Format('MyField%s1234', [OPERATOR_CHAR[Operation]]), Condition.Condition);
