...
type
  ...
  public
    ...
    [Test]
    procedure WhenInsertingARecursiveClassMustUpdateTheRecursiveClassAfterTheInsertionOfDependencies;
    [Test]
    procedure WhenUpdateARecursiveClassMustUpdateTheRecursiveClassAfterTheInsertionOfDependencies;
  end;
...
procedure TQueryBuilderDataManipulationTest.WhenInsertingARecursiveClassMustUpdateTheRecursiveClassAfterTheInsertionOfDependencies;
begin
  ...
  Assert.AreEqual(
    'insert into ClassRecursiveSecond()values()'#13#10 +
    'insert into ClassRecursiveThird(IdRecursive)values(111)'#13#10 +
    'insert into ClassRecursiveFirst(IdRecursive)values(222)'#13#10 +
    'update ClassRecursiveSecond set IdRecursive=333 where Id=111', DatabaseClass.SQL);
end;
...
begin
  ...
  Assert.StartsWith('insert into MyEntity(Name,Value)values('''',0)'#13#10, DatabaseClass.SQL);
end;
...
begin
  ...
  var MyClassCache := TManyValueParent.Create;
  MyClassCache.Id := 123;
  MyClassCache.Child := TManyValueChild.Create;
  MyClassCache.Child.Id := 123;

  AddObjectToCache(MyClassCache, 123);
  AddObjectToCache(MyClassCache.Child, 123);
...
procedure TQueryBuilderDataManipulationTest.WhenUpdateARecursiveClassMustUpdateTheRecursiveClassAfterTheInsertionOfDependencies;
begin
  FCursorClass.Values := [[111], [222], [333]];
  var First := TClassRecursiveFirst.Create;
  var RecursiveUpdate := TClassReferenceToRecursive.Create;
  RecursiveUpdate.Id := 888;
  RecursiveUpdate.Recursive := First;
  var Second := TClassRecursiveSecond.Create;
  Second.Recursive := First;
  var Third := TClassRecursiveThird.Create;
  Third.Recursive := Second;
  ...
  AddObjectToCache(TClassReferenceToRecursive.Create, 888);

  Builder.Update(RecursiveUpdate);

  Assert.AreEqual(
    'insert into ClassRecursiveSecond()values()'#13#10 +
    'insert into ClassRecursiveThird(IdRecursive)values(111)'#13#10 +
    'insert into ClassRecursiveFirst(IdRecursive)values(222)'#13#10 +
    'update ClassReferenceToRecursive set IdRecursive=333 where Id=888'#13#10 +
    'update ClassRecursiveSecond set IdRecursive=333 where Id=111', DatabaseClass.SQL);
end;
