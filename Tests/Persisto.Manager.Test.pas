...
begin
  ...
  var Cursor := FManager.OpenCursor('select Value from InsertAutoGenerated where Id = ''' + MainObject.Id + '''');
...
begin
  ...
  Assert.IsTrue(Cursor.Next);
  Assert.AreEqual<NativeInt>(45, Cursor.GetFieldValue(0));
end;
...
begin
  ...
  Assert.IsTrue(Cursor.Next);
  Assert.AreEqual(20, Integer(Cursor.GetFieldValue(0)));
end;
