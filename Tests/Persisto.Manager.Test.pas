...
begin
  ...
  MainObject.FK1 := CreateObject<TInsertAutoGenerated>;
...
procedure TManagerTest.PrepareDatabase;
  ...
  begin
    ...
    WithForeignKey.FK1 := CreateObject<TInsertAutoGenerated>;
...
begin
  ...
  FManager.Mapper.GetTable(TAutoGeneratedClass);
...
begin
  var ForeignKeyObject := CreateObject<TInsertAutoGenerated>;
...
begin
  var AnotherManager := TManager.Create(FConnection, CreateDatabaseManipulator);
