...
type
  ...
  public
    ...
    [Test]
    procedure TheCreateInsertStatementMustBeBuildAsExpected;
    [Test]
    procedure WhenTheTableAsAutoGeneratedFieldMustBuildTheInsertStatementAsExpected;
  end;
...
procedure TDatabaseManipulatorSQLServerTest.CheckExecution(const SQL: String);
begin
...
procedure TDatabaseManipulatorSQLServerTest.IfTheFieldTypeUsedIsntMappedMustLoadTheFieldTypeWithUnkownEnumerator;
begin
...
procedure TDatabaseManipulatorSQLServerTest.MustLoadAllIndexesInTheTablesAsExpected;
begin
//  FManipulator.LoadSchema(FSchema);
//
...
procedure TDatabaseManipulatorSQLServerTest.MustLoadTheReferenceFieldsOfTheForeignKey;
begin
//  FManipulator.LoadSchema(FSchema);
//
...
procedure TDatabaseManipulatorSQLServerTest.MustLoadTheTableNameFromTheCursorAsExpected;
begin
//  FManipulator.LoadSchema(FSchema);
...
//
//  FManipulator := TDatabaseManipulatorSQLServer.Create(FManager);
//
...
procedure TDatabaseManipulatorSQLServerTest.TheAutoGeneratedValueMustBeReturnedAsExpected(const AutoGeneratedType: TAutoGeneratedType; const ExpectedValue: String);
begin
...
procedure TDatabaseManipulatorSQLServerTest.TheColumnInfoMustBeLoadedHasExpected(const TableName, ColumnName, TypeName: String; const Size, Precision, Scale, Nullable: Word;
...
procedure TDatabaseManipulatorSQLServerTest.TheCreateInsertStatementMustBeBuildAsExpected;
begin
  ...
  var SQL := FManipulator.MakeInsertStatement(FMapper.GetTable(TMySQLiteTable), Params);
...
procedure TDatabaseManipulatorSQLServerTest.TheFieldsLoadedInForeignKeyMustLoadFieldFromTheTable;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.TheFieldsOfTheForeignKeyMustBeLoadedHasExpected;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.TheFieldTypeFunctionMustReturnTheTypeHasExpected(const FieldType: TTypeKind; const SpecialType: TDatabaseSpecialType;
  const FieldTypeComparision: String);
begin
  var Context := TRttiContext.Create;
  var Field := TField.Create(nil);
  Field.SpecialType := SpecialType;
  var Manipulator := TDatabaseManipulatorSQLServer.Create;
...
procedure TDatabaseManipulatorSQLServerTest.TheIndexMustLoadTheNameHasExpected;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.TheNameOfForeignKeyMustBeLoaded;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.TheReferenceFieldsMustBeLoadedWithTheReferenceFieldOfTheReferenceTable;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.TheReferenceTableOfForeignKeyMustBeLoaded;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenCallLoadTablesMustLoadAllTablesFromTheDatabase;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenCreateADefaultConstraintMustExecuteTheSQLAsExpected;
begin
...
procedure TDatabaseManipulatorSQLServerTest.WhenCreateARequiredTempFieldMustLoadTheDefaultValueHasExpected;
begin
...
procedure TDatabaseManipulatorSQLServerTest.WhenCreateARequiredUniqueIdentifierFieldMustCreateTheDefaultAsExpected;
begin
  var Field := FMapper.GetTable(TMyTestClass).Field['UniqueIdentifier'];
...
procedure TDatabaseManipulatorSQLServerTest.WhenCreateTheTempFieldMustCallTheBaseClassToExecuteTheCreation;
begin
  var Field := FMapper.GetTable(TMyTestClass).Field['Field'];
...
procedure TDatabaseManipulatorSQLServerTest.WhenCreateTheTempFieldNotRequiredCantLoadTheFixedValue;
begin
...
procedure TDatabaseManipulatorSQLServerTest.WhenDropAnIndexMustExecuteTheSQLAsExpected;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenDropAnIndexWithPrimaryKeyFlagMustExecuteADropConstraint;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenLoadingTheTableCantRaiseDuplicationError;
begin
//  Assert.WillNotRaise(
//    procedure
//    begin
...
procedure TDatabaseManipulatorSQLServerTest.WhenLoadTheFieldInfoMustLoadTheSpecialFieldInfo(const TableName, ColumnName: String; const SpecialType: TDatabaseSpecialType);
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenLoadTheIndexMustLoadAllFieldOfTheIndexHasExpected;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenLoadTheSequenceMustLoadTheNameOfTheSequenceAsExpected;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenLoadTheSequencesMustLoadTheSequenceList;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenLoadTheTableMustLoadTheColumnsOfTheTable;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenLoadTheTableMustLoadTheForeignKeysOfTheTable;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenRenameAColumnMustExecuteTheSQLAsExpected;
begin
  var Executed := False;
...
procedure TDatabaseManipulatorSQLServerTest.WhenTheFieldHasAFixedValueMustGenerateTheValueAsExpected;
begin
  var DefaultConstraint := TDefaultConstraint.Create;
...
procedure TDatabaseManipulatorSQLServerTest.WhenTheFieldHasASequenceMustGenerateTheValueAsExpected;
begin
  var DefaultConstraint := TDefaultConstraint.Create;
...
procedure TDatabaseManipulatorSQLServerTest.WhenTheIndexIsPrimaryKeyMustMarkTheInfoInTheIndex;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenTheIndexIsUniqueMustLoadTheInfo;
begin
//  FManipulator.LoadSchema(FSchema);
...
procedure TDatabaseManipulatorSQLServerTest.WhenTheTableAsAutoGeneratedFieldMustBuildTheInsertStatementAsExpected;
begin
  var Params := TParams.Create(nil);

  Params.CreateParam(ftInteger, 'Param', ptInput);

  var SQL := FManipulator.MakeInsertStatement(FMapper.GetTable(TAutoGeneratedClass), Params);
