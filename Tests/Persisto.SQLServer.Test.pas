...
procedure TManipulatorSQLServerTest.TheCreateInsertStatementMustBeBuildAsExpected;
begin
...
procedure TManipulatorSQLServerTest.WhenTheTableAsAutoGeneratedFieldMustBuildTheInsertStatementAsExpected;
begin
  var Params := TParams.Create(nil);
