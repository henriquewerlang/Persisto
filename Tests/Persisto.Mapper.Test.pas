...
begin
  ...
  Assert.AreEqual(ChildTable.Field['ManyValueAssociation'], Table.Associations[0].AssociatedField);
end;
...
begin
  ...
  Assert.AreEqual('ManyValueAssociation', Table.Associations[0].AssociatedField.PropertyInfo.Name);
end;
...
begin
  ...
  Assert.AreEqual(Table.Field['ManyValueAssociationList'], Table.Associations[0].Field);
end;
...
begin
  ...
  Assert.AreEqual(AssociatedTable, Table.Associations[0].AssociatedTable);
end;
...
begin
  ...
  Assert.AreEqual('IdManyValueAssociationParent', Table.Associations[0].AssociatedField.DatabaseName);
end;
...
begin
  ...
  Assert.IsTrue(Field.IsAssociation);
end;
...
begin
  ...
  Assert.IsTrue(Field.IsAssociation, 'Is many value association');
...
begin
  ...
  Assert.AreEqual(0, Length(FMapper.GetTable(TMyClassWithByteArray).Associations));
end;
...
procedure TMapperTest.WhenTheFieldIsAnArrayByteMustLoadTheSpecialTypeBinaryHasExpected;
begin
...
begin
  ...
  Assert.IsNotNil(Field.Association);
end;
...
begin
  Assert.AreEqual(1, Length(FMapper.GetTable(TManyValueClassInherited).Associations));
end;
