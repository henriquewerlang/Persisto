...
begin
  ...
  Assert.AreEqual<Integer>(0, Table.Field['Id'].Index);
  Assert.AreEqual<Integer>(1, Table.Field['Field1'].Index);
end;
...
begin
  ...
  Assert.AreEqual<Integer>(1234, MyClass.Lazy.LazyValue.Key.AsInteger);
...
begin
  ...
  Assert.AreEqual<Integer>(6, Table.AllFieldCount);
end;
...
begin
  ...
  Assert.AreEqual<Integer>(2, Table.Field['Field4'].Index);
  Assert.AreEqual<Integer>(3, Table.Field['Field3'].Index);
  Assert.AreEqual<Integer>(4, Table.Field['Field2'].Index);
  Assert.AreEqual<Integer>(5, Table.Field['Id'].Index);
end;
...
begin
  ...
  Assert.AreEqual<Integer>(2, Table.AllFieldCount);
end;
...
begin
  ...
  Assert.AreEqual<Integer>(15, Table.Fields[2].Size);
  Assert.AreEqual<Integer>(7, Table.Fields[2].Scale);
end;
...
begin
  ...
  Assert.AreEqual<Integer>(150, Table.Fields[1].Size);
end;
...
begin
  ...
  Assert.AreEqual<Integer>(20, Table.Field['FloatForeignKey'].Size);
  Assert.AreEqual<Integer>(5, Table.Field['FloatForeignKey'].Scale);
end;
...
begin
  ...
  Assert.AreEqual<Integer>(1234, Table.Field['Lazy'].Value[MyClass].AsInteger);
...
begin
  ...
  Assert.AreEqual<Integer>(123456, Field.Value[MyClass].AsInteger);
...
begin
  ...
  Assert.AreEqual<TClass>(TMyEntity3, Table.ClassTypeInfo.MetaclassType);
end;
