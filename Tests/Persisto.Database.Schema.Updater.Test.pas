...
type
  ...
  private
    FDatabaseMetadataUpdate: TDatabaseSchemaUpdater;
    FDatabaseSchema: TDatabaseSchema;
    FMapper: TMapper;
    FMetadataManipulator: IMock<IDatabaseManipulator>;
    FOnSchemaLoad: TProc;
...
procedure TDatabaseSchemaUpdaterTest.CleanUpDatabaseTables;
begin
...
procedure TDatabaseSchemaUpdaterTest.LoadDatabaseSchema(const Schema: TDatabaseSchema);
begin
...
function TDatabaseSchemaUpdaterTest.LoadDatabaseTable(const Table: TTable): TDatabaseTable;
begin
...
procedure TDatabaseSchemaUpdaterTest.RemoveField(const TableDatabaseName, FieldName: String);
begin
...
procedure TDatabaseSchemaUpdaterTest.RemoveForeignKey(const TableDatabaseName, ForeignKeyName: String);
begin
  var Table := FDatabaseSchema.Table[TableDatabaseName];
...
procedure TDatabaseSchemaUpdaterTest.RemoveIndex(const TableDatabaseName, IndexName: String);
begin
  var Table := FDatabaseSchema.Table[TableDatabaseName];
...
procedure TDatabaseSchemaUpdaterTest.RemoveTable(const TableDatabaseName: String);
begin
...
//  FMapper.DefaultCollation := 'MyCollation';
  FMetadataManipulator := TMock.CreateInterface<IDatabaseManipulator>(True);

//  FDatabaseMetadataUpdate := TDatabaseSchemaUpdater.Create(FMetadataManipulator.Instance);
...
procedure TDatabaseSchemaUpdaterTest.SetupFixture;
begin
  Setup;
...
procedure TDatabaseSchemaUpdaterTest.WhenCreateADatabaseTableMustAddItToTheSchema;
begin
...
procedure TDatabaseSchemaUpdaterTest.WhenUpdataDeDatabaseMustLoadAllTablesFromTheDataBase;
begin
